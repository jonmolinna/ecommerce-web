...
const ProductCar = () => {
    return (
        <div className='grid grid-cols-12 gap-x-4 shadow-md mb-4'>
            <img
                src="https://res.cloudinary.com/dhdxq3mkm/image/upload/v1646749018/e-commerce/chompa-1_mk2w8z.png"
                alt=""
                className='col-span-5'
            />
            <article className='col-span-7 relative'>
                <h2 className='text-base font-semibold mb-1'>Marca</h2>
                <div className='flex'>
                    <small className='text-sm mr-1'>Color:</small>
                    <small className='text-sm'>Verde</small>
                </div>
                <div className='flex'>
                    <small className='text-sm mr-1'>Talla:</small>
                    <small className='text-sm'>M</small>
                </div>
                <div className='flex mt-2'>
                    <small className='text-sm mr-1'>Precio:</small>
                    <small className='text-sm'>S/ 54.99</small>
                </div>
                ...
                <div className='flex mt-3'>
                    ...
                    <p className='text-lg font-semibold'>S/ 54.99</p>
                </div>
                <button className='text-pink-700 absolute right-0 top-0'>
