...
const Footer = () => {
    return (
        <div className='container mx-auto p-3 mt-7 border-t-2 border-neutral-300'>
            <aside>
                <h3 className='font-normal'>¡Síguenos!</h3>
                <div className='flex mt-2'>
                    <a href="index.html" className='text-pink-700 mr-3'>
